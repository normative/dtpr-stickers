...
function Security({
  ...
  return (
    <svg viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" data-export-icon>
      <defs>
        <polygon id="path-sec-1" points="0 0.0002 14.8147 0.0002 14.8147 17.9997 0 17.9997" />
      </defs>
